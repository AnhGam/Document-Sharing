...
using document_sharing_manager.UI.Presenters;
...
namespace document_sharing_manager.Documents
{
    public partial class Dashboard : Form, IDashboardContract
    {
        ...
        private document_sharing_manager.UI.Controls.DocumentPreviewPanel previewPanel;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            toolBtnRecent.Click += (s, ev) => { new document_sharing_manager.Documents.RecentFilesForm().ShowDialog(); };
            ...
            toolBtnDuplicate.Click += (s, ev) => { new document_sharing_manager.Documents.DuplicateDetectionForm().ShowDialog(); TriggerRefresh(); };
        ...
        {
            previewPanel = new document_sharing_manager.UI.Controls.DocumentPreviewPanel();
